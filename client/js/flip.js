                                 ...
                                 l, r, b ,t)
{
    ...
    var array1 = uvs.slice(0);
    array1[0] = r; array1[1] = b;
    array1[2] = r; array1[3] = t;
    array1[4] = l; array1[5] = t;
    array1[6] = l; array1[7] = b;

    array1[8] = r; array1[9] = b;
    array1[10] = r; array1[11] = t;
    array1[12] = l; array1[13] = t;
    array1[14] = l; array1[15] = b;
...
var createMosaicShader = function() {
    ...
    if (createMosaicShader.shader === undefined) {
        ...
        var fragmentshader = [
            ...
            "color += texture2D( Texture1, FragTexCoord0.xy);",
            "gl_FragColor = color;",
            "}",
            ""
        ].join('\n');
